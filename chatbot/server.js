/**
 * Salon Ministry Powai Salon Ministry Powai - AI Chatbot Backend Proxy Server
...
const SYSTEM_PROMPT = `You are "Salon Ministry Powai Concierge", a warm and professional AI assistant for Salon Ministry Powai — Mumbai's premier luxury hair salon.
...
1. Information about Salon Ministry Powai's services: Expert Hair Styling, Hair Spa, Bridal Makeup
...
4. General hair care tips and beauty advice aligned with Salon Ministry Powai's premium philosophy
5. Bridal and special occasion package inquiries

Salon Ministry Powai contact / booking: Clients should fill the booking form on the website or WhatsApp at +91 89498 53554. Located in Mumbai.

If asked something completely unrelated to beauty, politely redirect: "As the Salon Ministry Powai Concierge, I'm best suited to assist you with hair, beauty, and our Mumbai salon services."
...
// ── Health check ──────────────────────────────────────────────────
app.get("/health", (_, res) => res.json({ status: "Salon Ministry Powai Salon Ministry Powai Concierge API is running." }));

// ── Start ─────────────────────────────────────────────────────────
app.listen(PORT, () => {
  console.log(`\n✅  Salon Ministry Powai Hair Salon Chatbot Server running at http://localhost:${PORT}`);
