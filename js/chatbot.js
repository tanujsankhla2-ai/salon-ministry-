/**
 * Salon Ministry Powai Salon Ministry Powai — AI Chatbot Widget — js/chatbot.js
 * ─────────────────────────────────────────────
...
(() => {
    ...
    const SYSTEM_PROMPT = `You are "Salon Ministry Powai Concierge", a warm and professional AI beauty assistant for Salon Ministry Powai — Mumbai's premier luxury hair salon.
...
1. **Expert Hair Styling** — Precision cuts & luxury colour by senior Salon Ministry Powai stylists
2. **Hair Spa** — Deep conditioning and scalp treatments with Salon Ministry Powai's nourishing protocols
...
- **Modern Signature** — ₹349+ (Expert Styling, Deep Conditioning, Full Artistry, Salon Ministry Powai Gift) ⭐ Most popular
...
For unrelated questions, politely redirect: "As the Salon Ministry Powai Concierge, I'm best equipped to assist with hair, beauty, and our Mumbai salon services."`
    ...
    function buildWidget() {
        ...
        wrapper.setAttribute('aria-label', 'Salon Ministry Powai AI Chat Concierge');

        wrapper.innerHTML = `
            <!-- Toggle Bubble -->
            <button
                id="mrko-chat-toggle"
                aria-label="Open Salon Ministry Powai chat"
                aria-expanded="false"
                aria-controls="mrko-chat-window"
                title="Chat with Salon Ministry Powai Concierge"
            >
            ...
            <div
                ...
                role="dialog"
                aria-modal="true"
                aria-label="Salon Ministry Powai AI Chatbot"
                aria-hidden="true"
            >
                <!-- Header -->
                <div class="chat-header">
                    ...
                    <div class="chat-header-info">
                        <div class="chat-header-name">Salon Ministry Powai Concierge</div>
                ...
                <div class="chat-input-area">
                    <div class="chat-input-row">
                        <textarea
                            id="mrko-chat-input"
                            placeholder="Ask Salon Ministry Powai Concierge anything…"
                            rows="1"
                            maxlength="500"
                    ...
                    <p class="chat-footer-note" aria-hidden="true">✦ Powered by Salon Ministry Powai AI &bull; Gemini 2.0 Flash</p>
                </div>
            </div>
        `;
    ...
    function showTyping() {
        ...
        div.setAttribute('aria-label', 'Salon Ministry Powai Concierge is typing');
        div.innerHTML = `
            <div class="msg-avatar bot-avatar" aria-hidden="true"><i class="fas fa-spa"></i></div>
    ...
    async function sendMessage(text) {
        ...
        try {
            ...
            console.error('[Salon Ministry Powai Chatbot]', err);
        } finally {
            isTyping = false;
    ...
    function wireEvents() {
        ...
        if (waBtn) {
            waBtn.addEventListener('click', () => {
                window.open(`https://wa.me/${WHATSAPP_NUMBER}?text=Hello%20Salon Ministry Powai!%20I%27d%20like%20to%20inquire%20about%20a%20session.`, '_blank');
            });
        }
